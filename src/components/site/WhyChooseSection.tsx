  ...
  return (
    <section id="quality" className="section-pad bg-[var(--off-white)]">
      <div className="section-shell">
        ...
        >
          <Badge>
            <FilledIcon name="check" className="size-3.5 text-[var(--green)]" />
            Why choose us
          </Badge>
        ...
        >
          ...
          >
            <div className="relative h-[360px] overflow-hidden rounded-2xl bg-[var(--muted)]">
              <Image
            ...
            <div className="p-4 text-center">
              <h3 className="font-heading text-2xl font-bold tracking-[-0.04em] text-[var(--pine)]">Design built for long-term outdoor value</h3>
