  ...
  return (
    <section className="relative z-20 -mt-14 bg-[var(--off-white)] pb-6">
      <div className="section-shell">
        <div className="grid grid-cols-2 overflow-hidden rounded-3xl border border-white/20 bg-[var(--accent)] p-4 shadow-xl shadow-[rgba(244,122,31,0.22)] lg:grid-cols-4 lg:p-5">
