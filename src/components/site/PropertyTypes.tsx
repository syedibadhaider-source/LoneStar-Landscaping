  ...
  return (
    <section className="relative z-20 -mt-10">
      <div className="section-shell">
        <div className="grid grid-cols-2 overflow-hidden rounded-2xl border border-white/20 bg-[var(--accent)] p-4 shadow-xl shadow-[rgba(242,91,30,0.22)] lg:grid-cols-4 lg:p-5">
